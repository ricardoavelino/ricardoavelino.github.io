...
authors: "Ricardo Maia Avelino<sup>1,2</sup>, Rita Sevastjanova<sup>2</sup>, Tom Van Mele<sup>1</sup>, Philippe Block<sup>1</sup>, Mennatallah El-Assady<sup>2</sup>"
...
paper: https://genaicreativity.org/icml2026/files/49/49_paper.pdf
...
bibtex: |
  @inproceedings{avelino2026creativity,
    ...
    title     = {Creativity from Friction: Human--{AI} Interaction for Exploratory Structural Design},
    booktitle = {International Conference on Machine Learning (ICML 2026), Workshop on Human-AI Co-Creativity},
